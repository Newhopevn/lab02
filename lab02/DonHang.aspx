<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonHang.aspx.cs" Inherits="lab2.DonHang" %>
            ...
            <div class="col-md-12">
                ...
                <div class="row mb-2 mt-2">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator ID="rfvHoTen" runat="server" ForeColor="red"
                            ErrorMessage="Chưa nhập họ tên"  ControlToValidate="txtHoTen" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-3">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-9">
                        <asp:TextBox ID="txtMST" runat="server" CssClass="form-control"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="rfvMST" runat="server" ForeColor="red"
                            ErrorMessage="Chưa nhập mã số thuế"  ControlToValidate="txtMST" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
